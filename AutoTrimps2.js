var ATversion='Zek v4.3.0',atscript=document.getElementById('AutoTrimps-script'),basepath='https://kahojyun.github.io/AutoTrimps/',modulepath='modules/';null!==atscript&&(basepath=atscript.src.replace(/AutoTrimps2\.js$/,''));
var loadedScript = {};
...
function initializeAutoTrimps() {
    ...
    debug('AutoTrimps - test Fork Loaded!', '*spinner3');
}
